...
<template>
<svg xmlns="http://www.w3.org/2000/svg" role="img" class="iconify iconify--mdi" width="40" height="40" viewBox="0 0 24 24" fill="url(#myGradient)" preserveAspectRatio="xMidYMid meet">
